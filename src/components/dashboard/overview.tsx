    ...
    <>
        ...
        <Card className="shadow-md">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+5 sejak kemarin</p>
          </CardContent>
        </Card>
        <Card className="shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Dokter Jaga</CardTitle>
            <Stethoscope className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">12</div>
            <p className="text-xs text-muted-foreground">di 8 klinik</p>
          </CardContent>
        </Card>
    </>
  )
